...
# The exact function in the file
old_func = '''async def send_scan_summary(self, processed, total, skipped_already_sent, skipped_no_tickers, skipped_no_stock_data):
...
new_func = '''async def send_scan_summary(self, processed, total, skipped_already_sent, skipped_no_tickers, skipped_no_stock_data):
        ...
        try:
            for guild in self.guilds:
                ...
                embed1.add_field(
                    name="📈 Scan Summary",
                    value=f"**Total Posts:** {total}\\n**Processed:** {processed}\\n**Skipped (already sent):** {skipped_already_sent}\\n**Skipped (no tickers):** {skipped_no_tickers}\\n**Skipped (no stock data):** {skipped_no_stock_data}",
                    inline=False
                )
